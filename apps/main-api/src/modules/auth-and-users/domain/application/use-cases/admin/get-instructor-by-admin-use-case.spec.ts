...
import { GetInstructorByAdminUseCase } from './get-instructor-by-admin-use-case'
...
describe('GetInstructorByAdminUseCase', () => {
	let instructorRepo: InstructorRepository
	let sut: GetInstructorByAdminUseCase

	beforeEach(() => {
		instructorRepo = mock(InstructorRepository)
		sut = new GetInstructorByAdminUseCase({
