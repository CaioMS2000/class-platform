...
import { InstructorDeleteCourseUseCase } from './delete-course-use-case'
...
describe('InstructorDeleteCourseUseCase', () => {
	let courseRepo: CourseRepository
	let sut: InstructorDeleteCourseUseCase

	beforeEach(() => {
		courseRepo = mock(CourseRepository)
		sut = new InstructorDeleteCourseUseCase({
