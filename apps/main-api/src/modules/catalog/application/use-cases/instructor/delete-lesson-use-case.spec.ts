...
import { InstructorDeleteLessonUseCase } from './delete-lesson-use-case'
...
describe('InstructorDeleteLessonUseCase', () => {
	let lessonRepo: LessonRepository
	let courseRepo: CourseRepository
	let sut: InstructorDeleteLessonUseCase

	beforeEach(() => {
		lessonRepo = mock(LessonRepository)
		courseRepo = mock(CourseRepository)
		sut = new InstructorDeleteLessonUseCase({
