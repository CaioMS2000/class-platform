...
import { InstructorUpdateModuleUseCase } from './update-module-use-case'
...
describe('InstructorUpdateModuleUseCase', () => {
	let moduleRepo: ModuleRepository
	let courseRepo: CourseRepository
	let sut: InstructorUpdateModuleUseCase

	beforeEach(() => {
		moduleRepo = mock(ModuleRepository)
		courseRepo = mock(CourseRepository)
		sut = new InstructorUpdateModuleUseCase({
